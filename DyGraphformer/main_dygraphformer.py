...
from dygraph_exp.exp_dygraphformer import Exp_dygraphformer
from utils.tools import string_split

parser = argparse.ArgumentParser(description='DyGraphFormer')
...
parser.add_argument('--checkpoints', type=str, default='.', help='location to store model checkpoints')
...
parser.add_argument('--win_size', type=int, default=1, help='window size for segment merge')
...
parser.add_argument('--gcn_dim', type=int, default=8, help='The dimensions of the data in the graph convolution')
parser.add_argument('--gcn_heads', type=int, default=2, help='The heads of the data in the graph convolution')
parser.add_argument('--gcn_dropout', type=float, default=0.2, help='gcn_dropout')
...
Exp = Exp_dygraphformer

for ii in range(args.itr):
    # setting record of experiments
    setting = 'DyGraphformer_{}_il{}_ol{}_sl{}_win{}_fa{}_dm{}_nh{}_el{}_itr{}_g_dim{}'.format(args.data,
                args.in_len, args.out_len, args.seg_len, args.win_size, args.factor,
                args.d_model, args.n_heads, args.e_layers, ii,args.gcn_dim)
