...
from dygraph_exp.exp_basic import Exp_Basic
from dygraph_models.dygraph_former import DyGraphformer
...
class Exp_dygraphformer(Exp_Basic):
    def __init__(self, args):
        super(Exp_dygraphformer, self).__init__(args)
    ...
    def test(self, setting, save_pred = False, inverse = False):
        test_data, test_loader = self._get_data(flag='test')
        # self.model.load_state_dict(torch.load(self.args.checkpoints+'./'+'checkpoint48.pth'))
